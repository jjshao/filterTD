...
#' # Example
#' curve_perclost(sync_tags=sync_tag_data, hpe_col_name="HPE", hpem_col_name="HPEm", hpe_val=20)
#'
#' @export
#'
#' @import ggplot2
...
curve_perclost <- function(sync_tags, hpe_col_name, hpem_col_name, hpe_val) {
  Value <- Perc_Removed <- NULL
