...
percentage of data. 
``` {r echo = FALSE}
sync_hpe <- hpe.quantiles(sync_tag_data, hpe_col_name)
kable(sync_hpe)
```
...
``` {r echo = FALSE, results = 'asis'}
receiver.detections(sync_tags=sync_tag_data, sync_hpe_col_name=hpe_col_name, num_bins=num_bins,
